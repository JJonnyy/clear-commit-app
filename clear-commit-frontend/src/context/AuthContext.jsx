...
import { app, firebaseInitialized } from "../auth/firebase.jsx";
...
export function AuthProvider({ children }) {
    ...
    const auth = firebaseInitialized ? getAuth(app) : null;
    ...
    const syncAuthState = useCallback( async () => {
        try {
            const [serverAuth, firebaseUser] = await Promise.all([
                checkServerAuth(),
                firebaseInitialized ? checkFireBaseAuth() : Promise.resolve(null),
            ]);
